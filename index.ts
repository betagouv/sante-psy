...
app.get('/api/psychologue/mes-remboursements', xsrfProtection, reimbursementController.reimbursement);
app.post('/api/psychologue/renseigner-convention', xsrfProtection,

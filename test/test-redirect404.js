...
describe('Redirect if unknown page - 404', function() {
  ...
  it('should redirect to index page if unknown page and not loggued', async function() {
    return chai.request(app)
  ...
  it('should redirect to login page if unknown page starting with /psychologue/ and not loggued', async function() {
    return chai.request(app)
        .get('/psychologue/unknown-pizza')
        .redirects(0)
        .then(async (res) => {

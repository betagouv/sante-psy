...
export default {
  ...
  featureSendSummaryToUniversities: process.env.FEATURE_SEND_SUMMARY_TO_UNIVERSITIES || false,
  featureSendSummaryToMESRI: process.env.FEATURE_SEND_SUMMARY_TO_MESRI || false,
  emailsMESRI: process.env.EMAILS_MESRI || 'equipe-santepsyetudiants@beta.gouv.fr',

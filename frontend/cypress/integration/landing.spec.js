describe('Landing Page Test', () => {
  ...
  it('shows statistics', () => {
    ...
    cy.get('[data-test-id="statistic-Nombre de séances réalisées"]').should('exist');
    cy.get('[data-test-id="statistic-Nombre de séances réalisées-value"]').should('have.text', 156);

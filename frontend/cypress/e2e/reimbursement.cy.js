...
describe('Reimbursement', () => {
  ...
  describe('Display reimbursements', () => {
    it('should display reimbursements', () => {
      cy.get('[data-test-id="bill-summary-text"]').contains(
        'vous avez effectué 13 séances, auprès de 3 étudiants',
      );

      cy.get('[data-test-id="billing-table"] tr').should('have.length', 8);

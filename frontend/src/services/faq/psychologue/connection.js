...
module.exports = config => [
  {
    ...
    Une fois cela établi, si votre problème persiste, envoyez-nous un email à <a href="mailto:${config.contactEmail}">support-santepsyetudiant@beta.gouv.fr</a>`,
  },
  {
    question: 'Je souhaite modifier des informations sur mon espace. Comment puis-je faire ?',
    answer: `Pour modifier vos informations, envoyez-nous un email à <a href="mailto:${config.contactEmail}">support-santepsyetudiant@beta.gouv.fr</a> \

...
module.exports = () => [
  ...
  },
  {
    ...
    L'étudiant doit seulement vous présenter sa carte étudiante et sa lettre d'orientation de son médecin généraliste.",
  },
  {
  ...
  },
  {
    ...
    Pour cela, envoyez nous un email à support-santepsyetudiant@beta.gouv.fr nous le précisant.",
  },
  {
    question: 'Quelles informations dois-je vérifier auprès du patient lors de la séance ?',
    answer: 'Lors de chaque séance, vous devez renseigner les identités du médecin adresseur et de l’étudiant ainsi que confirmer que la séance a eu lieu. \

...
module.exports = () => [
  {
    question: 'Comment a été fixé le tarif de 30 euros pour une consultation, sachant que les tarifs varient selon les régions, \
    selon les formations complémentaires et spécialités de chaque professionnel\u00A0?',
    answer: 'S’agissant d’un dispositif national, le tarif doit être identique sur l’ensemble du territoire et il a été fixé à 30\u00A0€ par le ministère des solidarités et de la santé.',
  },
  {
  ...
  },
  {
    ...
    answer: 'La première étape est de déclarer vos séances réalisées sur votre espace psychologue. \
    Une fois la convention signée avec l’université, vous devez ensuite lui adresser vos facturations \
    selon ses modalités d’envoi. <br /> Si votre convention est en cours, nous vous invitons à patienter. \
    L’université de rattachement prendra contact avec vous sous 2 à 4 semaines pour signer votre convention \
    et vous transmettre ses modalités de facturation (numéro de bon de commande si nécessaire, mode d’envoi etc.).',
  },
];

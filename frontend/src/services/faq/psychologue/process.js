...
module.exports = config => [
  {
    ...
    poursuivre leur consultation avec vous, il est nécessaire qu’ils soient orientés vers un psychologue par le SSE dont \
    ...
    une convention avec l’université la plus proche de votre lieu d’exercice vous sera proposée et vous serez inscrit sur la liste des psychologues agréés par le SSE \
  ...
  },
  {
    ...
    answer: 'Dans le cadre du dispositif Santé Psy Étudiant, les étudiants doivent consulter le service de santé étudiante ou \
    un médecin généraliste qui peut les orienter vers un psychologue partenaire de la démarche.',
  },
  {
    question: 'Comment un étudiant sait s’il a un SSE\u00A0? Comment fait-il s’il n’en a pas\u00A0?',
    answer: 'Les étudiants peuvent savoir si leur établissement dispose d’un service de santé étudiante (SSE) ou s’ils ont accès au SSE \
    d’un autre établissement (par convention) en consultant le site de leur université\u00A0/ école ou en leur téléphonant. \
    Si l’étudiant n’a pas accès à un SSE, il peut se rendre chez un médecin généraliste qui l’orientera en cas de besoin vers un psychologue partenaire du dispositif.\
    D’une façon générale, les établissements disposant d’un SSE sont invités à ouvrir autant que possible leur service aux écoles partenaires ou partageant le site.',
  },
];

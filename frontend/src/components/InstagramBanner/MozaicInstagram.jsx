...
const MozaicInstagram = () => {
  const images = [
    ...
    { name: 'instaMozaic2', href: 'https://www.instagram.com/reel/CzeRhrkCCCJ/?utm_source=ig_web_copy_link&igsh=MzRlODBiNWFlZA==' },
    { name: 'instaMozaic3', href: 'https://www.instagram.com/p/C768qekI4uh/?utm_source=ig_web_copy_link&igsh=MzRlODBiNWFlZA==' },
    { name: 'instaMozaic4', href: 'https://www.instagram.com/p/C9CQne_oQNb/?utm_source=ig_web_copy_link&igsh=MzRlODBiNWFlZA==' },
    { name: 'instaMozaic5', href: 'https://www.instagram.com/p/C6MTi9xIyJy/?utm_source=ig_web_copy_link&igsh=MzRlODBiNWFlZA==' },
    { name: 'instaMozaic6', href: 'https://www.instagram.com/p/C5qD70jI7BT/?utm_source=ig_web_copy_link&igsh=MzRlODBiNWFlZA==' },
  ];

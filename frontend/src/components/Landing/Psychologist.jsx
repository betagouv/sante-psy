    ...
    <div className="fr-grid-row fr-grid-row--center fr-grid-row--gutters">
      <div className="fr-col fr-col-xs-10 fr-col-md-10">
        ...
        <div className="fr-pb-2w">
          ...
          <p className="fr-mb-2w">
            Une fois inscrit, et en cas d&lsquo;éligibilité,
            vos coordonnées apparaîtront dans l&lsquo;annuaire public des psychologues partenaires sur cette plateforme.
          ...
          <a className="fr-btn fr-btn--alt" href="<%= formUrl %>" target="_blank" rel="noopener noreferrer">

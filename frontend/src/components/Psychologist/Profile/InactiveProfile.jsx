...
const InactiveProfile = () => {
  ...
  return (
    ...
    >
      ...
      <RadioGroup
        legend="Vous nous avez indiqué vouloir quitter le dispositif Santé Psy Etudiant. Afin d’améliorer ce dernier, pouvez-vous nous indiquer la raison de ce choix :"
        ariaLabel="raison"
        name="reason"
        value={reason}

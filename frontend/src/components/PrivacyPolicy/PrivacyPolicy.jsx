    ...
    return (
      ...
      >
        ...
        <Section title="Données à caractère personnel traitées">
          ...
          <Title as="h3" look="h5">
            a) Données d&lsquo;inscription (psychologues)
          </Title>
          <p>
            ...
            formulaire au travers de &laquo; démarches simplifiées &raquo; (cliquez  
            {' '}
            <a 
            ...
            {' '}
             pour accéder au formulaire). Le service de santé universitaire (SSU) le
          ...
          <Title as="h3" look="h5">
            b) Données relatives aux séances (étudiants)
          </Title>
          ...
          <ul className="fr-list">
            ...
            <li>
              Ville du médecin qui a orienté l&lsquo;étudiant (optionnel)
            </li>
        ...
        <Section title="Base juridique du traitement de données">
          ...
          <p>
            ...
            et à la libre circulation de ces données. L'obligation légale est
            posée par la loi LCEN n° 2004-575 du 21 juin 2004 pour la confiance
            dans l'économie numérique et par les articles 1 et 3 du décret
            n°2011-219 du 25 février 2011.
          </p>
          <Title as="h4" look="h6">
            Cookies
          </Title>
          <p>
            ...
            l&lsquo;article 82 de la loi n°78-17 du 6 janvier 1978. Les cookies
            ...
            l&lsquo;utilisateur. Ce consentement de la personne concernée pour
            ...
            circulation de ces données. En l&lsquo;occurrence Santé Psy Etudiant
        ...
        <Section title="Durée de conservation">
          <table className="fr-table">
            ...
            <tr>
              ...
              <td>5 ans à compter de la dernière utilisation du compte</td>
            </tr>
            <tr>
              <td>Données relatives aux séances</td>
              <td>5 ans à compter de la dernière utilisation du compte</td>
            </tr>
            <tr>
              <td>Données de contact</td>
              <td>5 ans à compter de l&lsquo;écrit du message</td>
            </tr>
            <tr>
              <td>Données de connexion</td>
              <td>
                Ces données sont conservées 12 mois, en application de la loi
                pour la confiance dans l&lsquo;économie numérique n°2004-575 du
                21 juin 2004 et de l&lsquo;article 3 du décret n°2011-219 du 25
                février 2011.
              </td>
            </tr>
            <tr>
              <td>Cookies</td>
              <td>Ces données sont conservées 13 mois maximum.</td>
            </tr>
          </table>
        </Section>
        <Section title="Droit des personnes concernées">
          ...
          <p>
            ...
            dispositif Santé Psy Etudiant Sous-direction de la vie étudiante -
            DGESIP A2 1 rue Descartes 75005 Paris
          </p>
          <p>
          ...
          <table className="fr-table">
            ...
            <tr>
              ...
              <td>
                {' '}
                <a 
                    href="https://scalingo.com/fr/privacy-policy"
                    target="_blank"
                    rel="noreferrer"
                >
                https://scalingo.com/fr/privacy-policy
                </a>
                {' '}
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>France</td>
              <td>Dématérialisation de Démarches Administrative</td>
              <td>
                {' '}
                <a 
                    href="https://doc.demarches-simplifiees.fr/cgu/cgu"
                    target="_blank"
                    rel="noreferrer"
                >
                https://doc.demarches-simplifiees.fr/cgu/cgu
                </a>
                {' '}
              </td>
            </tr>
        ...
        <Section title="Utilisation de témoins de connexion (&laquo; cookies &raquo;)">
          ...
          <p>
            Nous utilisons pour cela Matomo, un outil de mesure d&lsquo;audience
